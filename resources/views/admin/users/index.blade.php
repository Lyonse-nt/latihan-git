...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-white">Kelola Akun User</h1>
            <p class="text-sm text-slate-400 mt-1">Daftar user dengan hak akses ke sistem (Developer, Admin, Member).</p>
        </div>
                        ...
                        <tr class="hover:bg-slate-850/30 transition-colors text-sm text-slate-300">
                            ...
                            <td class="p-4">
                                <span class="px-2.5 py-1 rounded-lg text-xs font-semibold 
                                    @if($usr->role === 'developer') bg-rose-500/10 text-rose-400 border border-rose-500/20
