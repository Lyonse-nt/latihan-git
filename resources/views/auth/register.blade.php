...
<head>
    ...
    <meta name="description" content="Register - A4A Community">
    <title>Daftar - A4A</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-6 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-3xl font-bold font-['Sora'] mb-2">Bergabung dengan Kami</h2>
                <p class="text-gray-400">Buat akun untuk menjadi bagian dari komunitas</p>
            </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="text-center">
                        <p class="text-gray-400">
                            Sudah punya akun? 
                            <a href="{{ route('login') }}" class="text-[#6366F1] hover:text-[#8B5CF6] font-semibold transition-colors">
                                Masuk
                            </a>
                        </p>
                    </div>
